 ...
 * Ships libcurl_jni.dylib as a classpath resource at
 * /cn/enaium/curl/native/darwin-aarch64/, which NativeLoader
...
val buildJniLibrary by tasks.registering(Exec::class) {
    group = "build"
    description = "Builds libcurl_jni.dylib for $classifier."
    onlyIf { canBuildHere }
